...
def populate():
    ...
    django_pages = [
        {'title': 'Official Django Tutorial',
         'url': 'https://docs.djangoproject.com/en/2.1/intro/tutorial01/', 'views':1300},
        {'title': 'Django Rocks',
         'url': 'http://www.djangorocks.com/', 'views':140},
        {'title': 'How to Tango with Django',
         'url': 'http://www.tangowithdjango.com/', 'views':50}]

    other_pages = [
        {'title': 'Bottle',
         'url': 'http://bottlepy.org/docs/dev/', 'views':190},
        {'title': 'Flask',
         'url': 'http://flask.pocoo.org', 'views':170}]
